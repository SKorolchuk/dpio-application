...
@NgModule({
    imports: [CommonModule, TranslateModule.forChild(), MaterialModule, RouterModule],
    declarations: [ShellComponent, LangSelectorComponent],
    exports: [ShellComponent, LangSelectorComponent],
    providers: [AuthenticationService, UserManagementService, AuthenticationGuard, I18nService],
})
