...
describe('HttpService', () => {
    ...
    describe('request', () => {
        it(
            'should prepend environment.serverUrl to the request url',
            fakeAsync(() => {
                // Act
        ...
        it(
            'should prepend environment.serverUrl to the request object url property',
            fakeAsync(() => {
                // Act
        ...
        it(
            'should go through default error handler and rethrow an error',
            fakeAsync(() => {
                // Arrange
        ...
        it(
            'should force request ignoring the cache',
            fakeAsync(() => {
                // Arrange
                const response = new Response(new ResponseOptions({ body: 'toto' }));
                spyOn(httpCacheService, 'setCacheData').and.callThrough();
        ...
        it(
            'should cache the request and return a copy of the response',
            fakeAsync(() => {
                // Arrange
