...
describe('QuoteService', () => {
    ...
    beforeEach(inject([QuoteService, MockBackend], (_quoteService: QuoteService, _mockBackend: MockBackend) => {
    ...
    describe('getRandomQuote', () => {
        it(
            'should return a random Chuck Norris quote',
            fakeAsync(() => {
                // Arrange
        ...
        it(
            'should return a string in case of error',
            fakeAsync(() => {
                // Arrange
